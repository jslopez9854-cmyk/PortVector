...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                        {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED, StrId::STR_THEME_CROSSPET, StrId::STR_THEME_CROSSPET_CLASSIC, StrId::STR_THEME_INKBOUND},
    ...
    &CrossPointSettings::clock12Hour,
    "clock12Hour",
    StrId::STR_CAT_DISPLAY),
    ...
    SettingInfo::Enum(StrId::STR_TEMP_UNIT, &CrossPointSettings::temperatureUnit,
      ...
      SettingInfo::Enum(StrId::STR_FONT_FAMILY, &CrossPointSettings::fontFamily,
                  {StrId::STR_BOOKERLY, StrId::STR_BOKERLAM, StrId::STR_LITERATA},
